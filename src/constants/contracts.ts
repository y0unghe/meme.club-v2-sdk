...
const SDK_CONTRACT_ADDRESSES = {
  ...
  ERC20: {
    ...
    [sepolia.id]: '0xEef28aa1d7772548fe27D929381EC97012816437',
  ...
  ERC1155: {
    ...
    [sepolia.id]: '0x8E8aC04EF9A4e606BAcE052155161FEe069C9C0f',
  ...
  BOND: {
    ...
    [sepolia.id]: '0x4F3d2Cb083dc0fe2c88695DCD5f7b53D71F682d5',
  ...
  ZAP: {
    ...
    [sepolia.id]: '0xD2D359b1AFb19e98E609671078226908E2986F5d',
  ...
  LOCKER: {
    ...
    [blast.id]: '0x168e4d9647F42d763939f8aD5b30A5B1C940DaB9',
  ...
  MERKLE: {
    ...
    [sepolia.id]: '0x186030c0D0f4b170dEe0A1bDe5499113fcD12399',
